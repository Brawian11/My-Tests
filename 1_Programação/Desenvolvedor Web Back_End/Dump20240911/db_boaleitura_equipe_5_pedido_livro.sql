...
CREATE TABLE `pedido_livro` (
  ...
  KEY `fk_pedido_has_livro_livro1_idx` (`livro_id`),
  KEY `fk_pedido_has_livro_pedido1_idx` (`pedido_id`),
  CONSTRAINT `fk_pedido_has_livro_livro1` FOREIGN KEY (`livro_id`) REFERENCES `livro` (`id_livro`),
  CONSTRAINT `fk_pedido_has_livro_pedido1` FOREIGN KEY (`pedido_id`) REFERENCES `pedido` (`id_pedido`)
